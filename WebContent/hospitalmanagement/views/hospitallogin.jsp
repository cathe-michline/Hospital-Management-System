...
<head>
    ...
    <div class="container">
      <div class="navbar-translate">
        <a class="navbar-brand" href="https://demos.creative-tim.com/material-kit/index.html">
          Hospital Management System - Hospital Login </a>
  ...
  <div class="page-header header-filter" style="background-image: url('https://img.freepik.com/premium-photo/blurred-interior-hospital-clinical-with-people-abstract-medical-background_1484-1309.jpg?w=2000'); background-size: cover; background-position: top center;">
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-6 ml-auto mr-auto">
          <div class="card card-login">
            ...
            <form class="form" action="Login?user=hospital" method="POST">
              ...
              <div class="card-body">
                <div class="input-group">
                  ...
                  <input type="text" name="email" class="form-control" placeholder="Hospital" required>
                </div>
                <br>
                <div class="input-group">
                  <div class="input-group-prepend">
